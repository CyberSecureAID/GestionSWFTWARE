...
const PROFILES={
  business:{
    ...
    modules:['dashboard','reports','simple','business','purchases','inventory','budgets','settings'],
  ...
  personal:{
    ...
    modules:['dashboard','reports','simple','personal','budgets','goals','settings'],
  ...
  all:{
    ...
    modules:['dashboard','reports','simple','personal','trade','budgets','goals','business','purchases','inventory','settings'],
