    ...
    ${budgetsThisMonth.length?budgetsThisMonth.map(b=>{
      ...
      return `<div class="budget-card">
        ...
        <div class="budget-foot">
          ...
          <button class="icon-btn" onclick="deleteBudget('${b.id}')" style="margin:-6px" title="Eliminar presupuesto" aria-label="Eliminar presupuesto"><i class="ti ti-trash"></i></button>
        </div>
      </div>`;
