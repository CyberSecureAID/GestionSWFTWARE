...
function invCard(item){
  ...
  return `<div class="inv-card">
    ...
    <div class="inv-card-actions">
      <button class="icon-btn edit" onclick="editInv('${item.id}')" title="Editar producto" aria-label="Editar producto"><i class="ti ti-pencil"></i></button>
      <button class="icon-btn" onclick="deleteInv('${item.id}')" title="Eliminar producto" aria-label="Eliminar producto"><i class="ti ti-trash"></i></button>
    </div>
  </div>`;
}
