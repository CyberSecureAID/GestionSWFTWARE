...
const GUIDE_HINTS_HTML=`
  <div class="guide-hints" style="margin-top:18px">
    ...
    <div class="guide-hint"><i class="ti ti-help-circle"></i> Si te pierdes en algún momento, toca el botón verde de ayuda (abajo a la derecha) para ver guías rápidas.</div>
  </div>
`;
