...
const NEXT_STEP_BY_PROFILE={
  ...
  all:{icon:'ti-rocket',title:'Registra tu primer movimiento',text:'Elige cualquier sección del menú y registra tu primer ingreso, gasto o venta. El dashboard se llenará solo a partir de eso.',page:'personal',cta:'Ir a Ingresos y Gastos'}
};

function renderEmptyDashboard(){
  const step=NEXT_STEP_BY_PROFILE[state.profile]||NEXT_STEP_BY_PROFILE.all;
