...
function renderPersonal(){
  ...
  document.getElementById('page-body').innerHTML=`
    ...
    <div class="metrics">
      ...
      <div class="metric-card ${inc-exp>=0?'green':'red'}"><div class="metric-label help-row">Balance ${helpBtn('concept_balance')}</div><div class="metric-value ${inc-exp>=0?'green':'red'}">${inc-exp>=0?'':'-'}${fmtShort(Math.abs(inc-exp))}</div></div>
